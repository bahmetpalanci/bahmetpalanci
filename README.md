...
Software Engineering Team Lead at [Melasoft](https://melasoft.com) — building enterprise e-invoicing and reconciliation platforms across Europe and the Middle East.

#### Tech

`Java` `Spring Boot` `Angular` `Swift` `JHipster` `Kafka` `Redis` `Docker`
...
[LinkedIn](https://linkedin.com/in/burakpalanci)
